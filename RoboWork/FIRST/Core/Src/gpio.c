...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : B_LED1_Pin PC14 B_LED3_Pin */
  GPIO_InitStruct.Pin = B_LED1_Pin|GPIO_PIN_14|B_LED3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : B_LED4_Pin B_LED5_Pin */
  GPIO_InitStruct.Pin = B_LED4_Pin|B_LED5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pin : F_LED5_Pin */
  GPIO_InitStruct.Pin = F_LED5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(F_LED5_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : F_LED4_Pin F_LED3_Pin F_LED2_Pin F_LED1_Pin */
  GPIO_InitStruct.Pin = F_LED4_Pin|F_LED3_Pin|F_LED2_Pin|F_LED1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
