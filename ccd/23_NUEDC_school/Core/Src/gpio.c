...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOF, PH1_Pin|PH2_Pin|ICG_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, MS1_Pin|MS2_Pin|BUZZ_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SH_GPIO_Port, SH_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : PFPin PFPin PFPin PFPin
                           PFPin PFPin */
  GPIO_InitStruct.Pin = PH1_Pin|MS1_Pin|PH2_Pin|MS2_Pin
                          |BUZZ_Pin|ICG_Pin;
